...
spppairs75prob <- function(data, site = "missing"){
  if(site %in% c("PP", "EBN")){
    ...
    if(site == "PP")
    {cast_PP_75 <- cast_PP[rownames(cast_PP) %in% sub_data_1 | rownames(cast_PP) %in% sub_data_2,]
      return(cast_PP_75)}
    else
    {cast_EBN_75 <- cast_EBN[rownames(cast_EBN) %in% sub_data_1 | rownames(cast_EBN) %in% sub_data_2,]
      return(cast_EBN_75)}}
  else
