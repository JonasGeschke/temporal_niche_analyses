...
cast_EBN_prob <- cast_site_prob(EBN_P, prob = 0.75, site = "EBN")
cast_EBN_prob <- cast_site_prob(EBN_C, prob = X, site = "EBN")
cast_PP_prob <- cast_site_prob(PP_P, prob = X, site = "PP")
cast_PP_prob <- cast_site_prob(PP_C, prob = X, site = "PP")
```
...
nicheoverlap_EBN_p <- nicheoverlap(cast_EBN_prob, method = "pianka", ra4 = F, iterations = 10, txt = T, site = "EBN")
```
