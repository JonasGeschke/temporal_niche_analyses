...
RA4result_EBN_p_perc95 <- nicheoverlap(cast_EBN, EBN_p_subset_perc95, method = "pianka", iterations = 5, site = "EBN")
RA4result_EBN_c_perc95 <- nicheoverlap(cast_EBN, EBN_c_subset_perc95, method = "czekanowski", iterations = 2, site = "PP")
```
