...
#ra4 randomization
RA4_pianka <- function(data, iterations = 1, site = "PP")
  {if(site %in% c("PP", "EBN")){
    ...
    repeat{
      ...
      # Czekanowski could be added here
    ...
    write.table(data_spp,
                file = paste("pianka", site, Sys.Date(),
                             format(Sys.time(), "%H-%M"), ".txt", sep="_"),
                sep = "\t",
                row.names = F)
    return(data_spp)
  }
  {return("Please set site to EBN or PP")}
  }
```
