...
EBN_subset_perc95 <- subset_spppairs(EBN_p, percentile = 0.95)
```
...
result_EBN_p_perc95 <- nicheoverlap(cast_EBN, EBN_subset_perc95, method = "pianka", iterations = 2, site = "EBN")
```
