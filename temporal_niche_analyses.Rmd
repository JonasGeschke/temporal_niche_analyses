...
plot(EBN_p[,3], EBN_c[,3],
  ...
  points(EBN_p_cut0.5[,3], subset(EBN_c, rownames(EBN_c) %in% rownames(EBN_p_cut0.5))[,3], pch = 3, col = "red")

#subsetting the pianka data, so only >=0.5 probability species pairs are in the dataset
...
plot(PP_p[,3], PP_c[,3],
  ...
  points(PP_p_cut0.75[,3], subset(PP_c, rownames(PP_c) %in% rownames(PP_p_cut0.75))[,3], pch = 3, col = "red")
